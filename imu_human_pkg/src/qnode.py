...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.pushButton_human_active.setDisabled(True)
        self.pushButton_human_active.setToolTip("ONLY SIMULATION: move robot to home in Moveit")
        self.pushButton_robot_active.setDisabled(True)
        self.pushButton_robot_active.setToolTip("Human and robot initial poses are mapped")
        ...
        self.pushButton_human_robot_init.clicked.connect(self.connect.human_robot_init_clicked)
